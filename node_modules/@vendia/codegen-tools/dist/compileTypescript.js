...
export const compileTs = (entry, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const config = defineConfig(Object.assign({ 
        ...
        legacyOutput: true, entryPoints: [entry], silent: !process.env.VENDIA_DEBUG, config: false }, options));
