...
var Employee__getDocument = gql`
  ...
  get_Employee(id: $id, version: $version) {
    ...
    `;
var Employee__listDocument = gql`
  ...
  list_EmployeeItems(nextToken: $nextToken, limit: $limit, filter: $filter) {
    ...
    `;
var Employee__addDocument = gql`
    mutation Employee__add($input: Self_Employee_Input_!, $syncMode: Vendia_SyncMode = NODE_LEDGERED) {
  add_Employee(input: $input, syncMode: $syncMode) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
var Employee__updateDocument = gql`
    mutation Employee__update($id: ID!, $input: Self_Employee_UpdateInput_!, $syncMode: Vendia_SyncMode = NODE_LEDGERED, $condition: Self_Employee_ConditionInput_) {
  update_Employee(
    id: $id
    input: $input
    syncMode: $syncMode
    ...
    `;
var Employee__removeDocument = gql`
  ...
  remove_Employee(id: $id, syncMode: $syncMode, condition: $condition) {
    ...
    `;
var Employee__onAddDocument = gql`
  ...
  onAdd_Employee {
    ...
    `;
var Employee__onRemoveDocument = gql`
  ...
  onRemove_Employee {
    ...
    `;
var Employee__onUpdateDocument = gql`
    ...
    employee: {
      get(id, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(Employee__getDocument, variables, wrappedRequestHeaders).then((res) => res.get_Employee);
        }, "get_Employee");
      },
      list(options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(Employee__listDocument, variables, wrappedRequestHeaders).then((res) => {
            var _a;
            const updatedRes = { ...res.list_EmployeeItems, items: (_a = res.list_EmployeeItems) == null ? void 0 : _a._EmployeeItems };
      ...
      add(input, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(Employee__addDocument, variables, wrappedRequestHeaders).then((res) => res.add_Employee);
        }, "add_Employee");
      },
      update(input, options) {
        ...
        return _requestWrapper((wrappedRequestHeaders) => {
          return _gqlClient.request(Employee__updateDocument, variables, wrappedRequestHeaders).then((res) => res.update_Employee);
        }, "update_Employee");
      },
      remove(id, options) {
        const variables = { ...options, id };
